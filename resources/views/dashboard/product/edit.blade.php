                    ...
                    <div class="row">
                        ...
                        <div class="card card-primary">
                          ...
                          <div class="card-body">
                            <div class="form-group">
                              ...
                              <input type="text" name="name" value="{{$product->name}}"id="inputName" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <input type="number"  value="{{$product->purchase_price}}" min=0 name="purchase_price" placeholder = "$" id="inputClientCompany" class="form-control">
                            </div>
                            <div class="form-group">
                              <label for="inputProjectLeader">Sale Price</label>
                              <input type="number" value="{{$product->sale_price}}" min=0 name="sale_price" id="inputProjectLeader" class="form-control" placeholder="$">
                            </div>
                            <div class="form-group">
                                <label for="inputProjectLeader">Stoke</label>
                                <input type="number" min=0 value="{{$product->stoke}}" name="stoke" placeholder="Number" id="inputProjectLeader" class="form-control">
                              </div>
                          </div>
                      ...
                      <div class="col-md-6">
                        <div class="card card-secondary">
                          ...
                          <div class="card-body">
                            <img class="img-fluid image_preview" src="{{$product->image_path}}" alt="Photo" style="max-height: 400px;">
                            <br>
                            <br>
